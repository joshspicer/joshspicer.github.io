...
description: >-
  I recently moved to the UK for my semester abroad. While still at home, I knew I wanted to pick up
  a local SIM card when arriving in Europe. Local SIMs in the UK are pretty...
...
5.  On your daily iphone, enable the additional phone number in your Message settings
    <p></p>
    ![iphone-photo](/assets/resources-sim-hack/iphone-photo.jpeg)
    <p></p>
...
4.  Connect and manage your device from across the world!
    <p></p>
    ![vnc](/assets/resources-sim-hack/VNC.png)
