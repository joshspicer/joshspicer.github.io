...
description: >-
  👋 [Sept 2024] This post was updated with improvements to both the service (now hosted as an Azure
  Function) and the ESP module programming (using an esphome config). See the...
...
![2](/assets/resources-heartbox/2.jpg)
...
```yaml
# (c) 2024 Josh Spicer <hello [at] joshspicer [dot] com>
...
![3](/assets/resources-heartbox/3.jpg)
