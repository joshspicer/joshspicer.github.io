...
description: "🚧 NOTE: Jarvis is currently a work in progress"
...
<!-- ![1.png](/assets/resources-jarvis/1.png) -->
...
- `dev.env` environment variable file. See [example.env](https://github.com/joshspicer/jarvis/blob/main/example.env) for an idea of what secrets are necessary.

- [Codespace repo-scoped secrets](https://docs.github.com/en/enterprise-cloud@latest/rest/codespaces/repository-secrets) for [each required secret](https://github.com/joshspicer/jarvis/blob/main/example.env).
