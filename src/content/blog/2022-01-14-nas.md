...
description: >-
  For a long time i've wanted to add a NAS to my homelab setup. I found that offerings from Synology
  seem great, but are quite pricy for the lack of flexibility the device...
...
<!-- ![1.png](/assets/resources-nas/1.png) -->
...
![enclosure](/assets/resources-nas/1.jpeg)
...
![built](/assets/resources-nas/2.jpg)
