...
description: "UPDATE: In August 2021 I released a revised version of this project that runs on Azure."
...
> UPDATE: In August 2021 I released a [revised version](/spotify-now-playing-azure) of this project that runs on Azure.
...
![dynamo-1](/assets/resources-spotify-lambda-post/dynamo-1.png)

You'll then need to add two additional keys: `accessToken` and `expiresAt`.

![dynamo-2](/assets/resources-spotify-lambda-post/dynamo-2.png)
...
![api-1](/assets/resources-spotify-lambda-post/api-1.png)

You'll then want to click on your new resource, and add a `GET` method to it.

![api-2](/assets/resources-spotify-lambda-post/api-2.png)

![api-3](/assets/resources-spotify-lambda-post/api-3.png)
...
![api-4](/assets/resources-spotify-lambda-post/api-4.png)
