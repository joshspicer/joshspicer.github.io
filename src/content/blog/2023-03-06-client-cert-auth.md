...
description: >-
  I recently set up a Cloudflare Tunnel and wanted to find a way to protect that resource. I primary
  use an Apple Watch app to communicate with this service.
published: "2023-03-06"
slug: client-cert-auth
tags:
  - networking
  - hacking
---
...
![2.png](/assets/resources-client-cert-auth/2.png)
...
![1.png](/assets/resources-client-cert-auth/1.png)
