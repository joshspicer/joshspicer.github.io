...
description: >-
  LLVM is super cool and incredibly powerful. For my compilers course this past semester, we had to
  implement an optimization pass on LLVM IR to remove trivially dead code.
...
![dot](/assets/resources-llvm/dot.png)
