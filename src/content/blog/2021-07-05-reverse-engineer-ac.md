...
description: >-
  As a part of homekit-ifying my apartment, i've been wanting to make my window A/C unit a bit
  smarter. I have a Keystone remote-controlled A/C - below is the journey of...
...
<!-- ![1.png](/assets/resources-reverse-engineer-ac/1.png) -->
...
>
> See my [previous HomeKit article for more info on initial setup](/homekit-esp8266).
...
![2.png](/assets/resources-reverse-engineer-ac/2.JPG)

![3.png](/assets/resources-reverse-engineer-ac/3.JPG)

![4.png](/assets/resources-reverse-engineer-ac/4.JPG)
...
Utilizing my previous [ESP HomeKit boilerplate](/homekit-esp8266), and by referring to the [HomeKit specificaton](https://developer.apple.com/homekit/specification/) published by Apple, I implemented a `Heater Cooler` accessory with several services. 
...
![1.png](/assets/resources-reverse-engineer-ac/5.jpeg)
