...
description: >-
  One feature I really liked from my old Xfinity router were the push notifications it sent when new
  devices first joined my wireless network. In this post we're recreating that...
...
![1.png](/assets/resources-openwrt-alert/1.png)
