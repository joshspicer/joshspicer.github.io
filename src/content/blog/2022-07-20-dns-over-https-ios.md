...
description: >-
  I recently discovered Paul Miller's blog post and repo sharing how to craft iOS configuration
  profiles that instruct iOS (or macOS/tvOS/watchOS/etc) to use a provided DNS over...
