...
description: >-
  The Inkplate 10 is an awesome, hackable e-ink display. It's a 9.7" display with a resolution of
  1200x825. It's also a dev board, with an ESP32, SD card slot, and LiPo battery...
...
![gif](/assets/resources-eink/demo.gif)
...
![rice](/assets/resources-eink/rice.jpg)
...
![siri](/assets/resources-eink/siri.png)
