...
description: >-
  A while back, I got one of those "smart" air purifiers to sit in my room while I work-from-home.
  Like a lot of IoT devices, this fan works only with a proprietary app, requires...
published: "2022-05-07"
slug: hack-air-purifier
tags:
  - networking
  - linux
  - hacking
...
![1.png](/assets/resources-hack-air-purifier/1.png)
...
![1.png](/assets/resources-hack-air-purifier/arp.png)
...
![dns-normal.png](/assets/resources-hack-air-purifier/dns-normal.png)

Here is the captured DNS request being spoofed.

![dns-spoof-terminal.png](/assets/resources-hack-air-purifier/dns-spoof-terminal.png)

The spoofed DNS response from your DNS proxy server in wireshark.

![dns-spoof.png](/assets/resources-hack-air-purifier/dns-spoof.png)
...
![syn9090.png](/assets/resources-hack-air-purifier/syn9090.png)
